...
This is a simple, minimal and quickly developed (in 2-3 hours simultaneously learning Laravel) notice board app made with Laravel and Tailwind CSS following the project instructions. There are lots of possibilities to upgrade this app.
